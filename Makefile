...
snips:
	curl -L https://github.com/mybee/snips/releases/download/v0.2.16/snips-v0.2.16-${shell go env GOOS}_amd64.tar.gz | tar zx

../qingcloud-api-specs/package.json:
	-go get -d github.com/mybee/qingcloud-api-specs
	file %@
...
unit-coverage:
	...
	for pkg in ${PKGS_TO_CHECK}; do \
		output="coverage$${pkg#github.com/mybee/qingcloud-sdk-go}"; \
		mkdir -p $${output}; \
...
ADD . /go/src/github.com/mybee/qingcloud-sdk-go
WORKDIR /go/src/github.com/mybee/qingcloud-sdk-go
